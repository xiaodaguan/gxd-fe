  ...
  <section>
    ...
    <div class="temperature__right">
      ...
      <div class="temperature__high">
        <img src="@/assets/icons/high.svg" alt="high temperature" /><span>{{ scaleSymbol === "C" ? high : fHigh }}</span
        >&deg;
      </div>
      <div class="temperature__low">
        <img src="@/assets/icons/low.svg" alt="low temperature" /><span>{{ scaleSymbol === "C" ? low : fLow }}</span
        >&deg;
      </div>
    </div>
  </section>
